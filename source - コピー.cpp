...
using namespace std;
#define     MINE    10         // îöíeêî
#define     WD     9          // î’ñ â°êî
#define     HT      9          // î’ñ ècêî
...
vector<string> zen = { "ÇO","ÇP","ÇQ","ÇR","ÇS","ÇT","ÇU","ÇV","ÇW","ÇX" };
...
int main(){
	string s;
	cout << "ÉXÉ^Å[ÉgÇ∑ÇÈèÍçáÇÕ[yes]Çì¸óÕÇµÇƒÇ≠ÇæÇ≥Ç¢" << endl;
	cin >> s;
	while (s == "yes") {
		resetboad();
		while (1) {
